...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/invoicing/master/_listings/akamai/invoicing-api-v2-accounts-accountid-invoices-year,month-get.md
x-common:
- type: x-base
